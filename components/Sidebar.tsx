...
export default function Sidebar() {
      ...
      {navItems.map((item) => {
        ...
        return (
          ...
          >
            ...
            {isActive && (
              <span className="absolute right-4 w-2 h-2 rounded-full bg-[#2563EB]" />
            )}
          </Link>
        );
      })}
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex md:w-64 bg-white border-r border-[var(--color-border)] flex-col h-screen sticky top-0">
        ...
        {open && (
          <>
            ...
            <motion.aside
              ...
              className="fixed top-0 left-0 w-64 h-full bg-white z-50 flex flex-col shadow-xl"
            >
              {/* HEADER */}
